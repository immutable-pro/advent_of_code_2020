...
const additionalVerificationFields = new Set<Field>(['byr', 'iyr', 'eyr', 'hgt']);
    ...
    for (const field of additionalVerificationFields) {
        ...
        switch (field) {
            ...
            case 'hgt':
                ...
                if (metric === 'cm' && !numberFitsRange(heightStr, 150, 193)) return false;
                if (metric === 'in' && !numberFitsRange(heightStr, 59, 76)) return false;
                break;
            case 'iyr':
